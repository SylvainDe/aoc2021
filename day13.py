...
def apply_folds(dots, folds):
    fold_funcs = { "x": x_fold, "y": y_fold }
    for axis, line in folds:
        f = fold_funcs[axis]
        dots = {f(d, line) for d in dots}
    return dots
...
def run_tests():
    ...
    assert dots == {(9, 10), (6, 12), (2, 14), (9, 0), (8, 4), (3, 4), (10, 4), (0, 13), (0, 3), (8, 10), (3, 0), (6, 10), (10, 12), (6, 0), (1, 10), (4, 11), (0, 14), (4, 1)}
    # Step by step
    dots = {y_fold(d, 7) for d in dots}
    assert dots == {(0, 1), (9, 0), (6, 2), (8, 4), (3, 4), (4, 3), (0, 0), (10, 4), (0, 3), (2, 0), (6, 4), (1, 4), (3, 0), (6, 0), (4, 1), (10, 2), (9, 4)}
    dots = {x_fold(d, 5) for d in dots}
    assert dots == {(0, 1), (4, 4), (2, 4), (4, 0), (0, 4), (3, 4), (4, 3), (0, 0), (0, 3), (2, 0), (4, 2), (1, 4), (3, 0), (0, 2), (1, 0), (4, 1)}
    # All at once
    dots, folds = get_info_from_lines(info)
